# 🍪 Cookiie 대화형 챗봇 작동 원리

## 📋 개요

Cookiie는 **"뇌처럼"** 학습하고 대화하는 AI입니다. GPT/LLaMA 같은 대규모 언어 모델과는 다른 방식으로 작동합니다.
...
👤 사용자: 나는 GNJz라고 해
🍪 Cookiie: 알겠어요! GNJz이라고 기억할게요! 😊
   → 학습 경로: 해마에 저장

👤 사용자: 나는?
🍪 Cookiie: 당신의 이름은 GNJz입니다.
   → 답변 경로: 해마에서 검색 → 포맷팅
...
### GPT/LLaMA vs Cookiie

| 항목 | GPT/LLaMA | Cookiie |
|------|-----------|--------|
